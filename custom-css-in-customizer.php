...
/*
 * Plugin Name: Jetpack Custom CSS in Customizer
 * Plugin URI: https://github.com/Automattic/jetpack/tree/custom-css-in-customizer
 * Description: Custom CSS in Customizer
 * Author: The Jetpack Team
 * Version: 0.1-dev
 * Author URI: https://jetpack.com
 */

class EGS_Jetpack_Custom_CSS_Customizer {
	...
	public static function init() {
		...
		if ( file_exists( JETPACK__PLUGIN_DIR . 'modules/custom-css/custom-css-in-customizer.php' ) ) {
			return;
		}
	...
	public static function customize_register( $wp_customize ) {
		EGS_jetpack_custom_css_control_class();

		$wp_customize->add_setting( new EGS_Jetpack_Custom_Css_Setting( $wp_customize, 'jetpack_custom_css[css]', array(
			'default' => '',
		...
		$wp_customize->add_control( new EGS_Jetpack_Custom_CSS_Control( $wp_customize, 'jetpack_custom_css_control', array(
	...
	public static function customize_controls_enqueue_scripts() {
		wp_register_style( 'jetpack-css-codemirror', plugins_url( 'modules/custom-css/custom-css/css/codemirror.css', JETPACK__PLUGIN_FILE ), array(), '20120905' );
		wp_enqueue_style( 'jetpack-css-customizer-control', plugins_url( 'css/customizer-control.css', __FILE__ ), array( 'jetpack-css-codemirror' ), '20140728' );

		wp_register_script( 'jetpack-css-codemirror', plugins_url( 'modules/custom-css/custom-css/js/codemirror.min.js', JETPACK__PLUGIN_FILE ), array(), '3.16', true );
		wp_enqueue_script( 'jetpack-css-customizer-control', plugins_url( 'js/customizer-control.js', __FILE__ ), array( 'customize-controls', 'underscore', 'jetpack-css-codemirror' ), '20140728', true );
	...
	public static function customizer_preview_init() {
		wp_enqueue_script( 'jetpack-custom-css-customizer', plugins_url( 'js/customize-frontend.js', __FILE__ ), array( 'customize-preview', 'underscore' ), '', true );
	}
...
function EGS_jetpack_custom_css_control_class() {
	if ( class_exists( 'EGS_Jetpack_Custom_CSS_Control' ) ) {
		return;
	}

	class EGS_Jetpack_Custom_CSS_Control extends WP_Customize_Control {
	...
	class EGS_Jetpack_Custom_Css_Setting extends WP_Customize_Setting {
		/**
...
add_action( 'init', array( 'EGS_Jetpack_Custom_CSS_Customizer', 'init' ) );